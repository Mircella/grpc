...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<kz.mircella.grpc.greet.GreetRequest,
      kz.mircella.grpc.greet.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = kz.mircella.grpc.greet.GreetRequest.class,
      responseType = kz.mircella.grpc.greet.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<kz.mircella.grpc.greet.GreetRequest,
      kz.mircella.grpc.greet.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<kz.mircella.grpc.greet.GreetRequest, kz.mircella.grpc.greet.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<kz.mircella.grpc.greet.GreetRequest, kz.mircella.grpc.greet.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kz.mircella.grpc.greet.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  kz.mircella.grpc.greet.GreetResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greet(kz.mircella.grpc.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<kz.mircella.grpc.greet.GreetResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                kz.mircella.grpc.greet.GreetRequest,
                kz.mircella.grpc.greet.GreetResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetServiceBlockingStub> {
     ...
     * </pre>
     */
    public kz.mircella.grpc.greet.GreetResponse greet(kz.mircella.grpc.greet.GreetRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<kz.mircella.grpc.greet.GreetResponse> greet(
        kz.mircella.grpc.greet.GreetRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((kz.mircella.grpc.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<kz.mircella.grpc.greet.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return kz.mircella.grpc.greet.Greet.getDescriptor();
    }
